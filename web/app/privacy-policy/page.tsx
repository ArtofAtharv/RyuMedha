    ...
    <main className="bg-background text-foreground relative min-h-dvh overflow-hidden">
      ...
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8">
        ...
        <div className="mb-10 flex flex-col gap-2">
          ...
          <h1 className="text-foreground text-3xl font-extrabold tracking-tight sm:text-4xl">Privacy Policy</h1>
          <p className="text-muted-foreground text-sm">
            Last updated: <span className="text-foreground font-medium">{lastUpdated}</span>
          </p>
          <p className="text-muted-foreground mt-2 text-sm leading-relaxed">
            At <strong className="text-foreground">Ryu Medha</strong> ("we", "our", or "us"), your privacy is important
            to us. This Privacy Policy explains how we collect, use, and protect your information when you use our
            academic tracking platform at{" "}
        ...
        <div className="border-border/70 bg-card/60 flex flex-col gap-8 rounded-2xl border p-6 shadow-xl backdrop-blur-md sm:p-8">
          <Section title="1. Information We Collect">
            ...
            <ul className="flex list-disc flex-col gap-1.5 pl-5">
              ...
              <li>
                <strong className="text-foreground">Google API Access:</strong> With your explicit permission, we access
                Google Tasks and Google Calendar APIs to sync your tasks and schedule.
              </li>
              <li>
                <strong className="text-foreground">Academic Data:</strong> Subject names, attendance records, grades,
                timer sessions, and other academic data you enter into the app.
              </li>
              <li>
          ...
          <Section title="2. How We Use Your Information">
            ...
            <p>
              We <strong className="text-foreground">do not</strong> sell, rent, or share your personal information with
          ...
          <Section title="3. Google API Services">
            <p>
              Ryu Medha uses Google APIs to provide certain features. Our use of information received from Google APIs
              adheres to the{" "}
              <a
          ...
          <Section title="4. Data Storage and Security">
            <p>
              ...
              , a trusted open-source backend platform that provides enterprise-grade security including row-level
              security (RLS) to ensure each user can only access their own data.
            </p>
            <ul className="flex list-disc flex-col gap-1.5 pl-5">
          ...
          <Section title="5. Data Retention">
            <p>
              We retain your data for as long as your account is active. If you delete your account or request data
              deletion, we will remove your personal information and academic records within 30 days, except where
              required by law.
            </p>
          </Section>
          ...
          <Section title="6. Your Rights">
            ...
            <ul className="flex list-disc flex-col gap-1.5 pl-5">
              ...
              <li>
                <strong className="text-foreground">Correction:</strong> Update inaccurate information via your profile
                settings.
              </li>
              <li>
              ...
              <li>
                <strong className="text-foreground">Withdrawal:</strong> Revoke Google permissions from your Google
                Account at any time.
              </li>
            </ul>
            <p>
          ...
          <Section title="9. Children's Privacy">
            <p>
              ...
              information from children under the age of 13. If you believe a child has provided us with personal data,
