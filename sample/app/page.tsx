...
import { HiArrowRight, HiAcademicCap, HiLightningBolt, HiShieldCheck, HiChartBar } from "react-icons/hi";
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20">
        <div className="bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest mb-8 animate-in delay-100 fade-in zoom-in duration-500">
          v2.0 Now Available
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 max-w-4xl bg-gradient-to-br from-zinc-900 via-zinc-700 to-zinc-400 dark:from-white dark:via-zinc-200 dark:to-zinc-500 bg-clip-text text-transparent pb-2 animate-in slide-in-from-bottom-10 duration-700">
          Master your academic life. Without the chaos.
        </h1>
