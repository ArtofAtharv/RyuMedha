...
sudo cp supabase/nlp_updated.ts supabase/functions/whatsapp-bot/nlp.ts
sudo cp supabase/nlp_updated.ts supabase/functions/whatsapp-webhook/nlp.ts
echo "Processors and NLP updated successfully!"
echo ""
